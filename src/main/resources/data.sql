INSERT IGNORE INTO idiomas (nombre, fecha_creacion) VALUES
('Árabe', CURRENT_TIMESTAMP),
('Rumano', CURRENT_TIMESTAMP),
('Chino Mandarín', CURRENT_TIMESTAMP);

INSERT IGNORE INTO alumnos (nombre, apellidos, email, numero_telefono, fecha_creacion, direccion, idioma_id) VALUES
