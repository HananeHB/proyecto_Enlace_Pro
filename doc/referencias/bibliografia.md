# 📚 Bibliografía y Recursos
  ...
  <img src="https://img.shields.io/badge/Documentation-References-blue?style=for-the-badge&logo=read-the-docs" />
  <img src="https://img.shields.io/badge/Stack-Spring_Boot_3-green?style=for-the-badge&logo=springboot" />
...
Estos recursos han sido esenciales para la configuración del Backend y el manejo de la persistencia de datos.
...
Para lograr el diseño "Liquid Glass" y la maquetación responsive, hemos utilizado las siguientes herramientas:

* **Tailwind CSS**: [Tailwind Documentation](https://tailwindcss.com/docs). Utilizada para todo el estilado de las vistas mediante clases de utilidad.
...
Específicamente para las funcionalidades críticas de exportación y traducción:
...
Recursos que facilitaron la organización y la arquitectura del proyecto:

* **Modelo C4**: [C4 Model Official Site](https://c4model.com/). Guía para la creación de los diagramas de contexto y contenedores.
...
Para el análisis de requisitos y lógica de negocio:

* **Comunidad de Madrid**: [Portal de Educación - Aulas de Enlace](https://www.comunidad.madrid/servicios/educacion/atencion-diversidad). Información sobre el funcionamiento real de estas aulas para adaptar los casos de uso a la realidad docente.

---

  <br>
  <img src="https://img.shields.io/badge/Format-Markdown_Reference-gray?style=flat-square" />
  <img src="https://img.shields.io/badge/Reliability-Verified_Sources-success?style=flat-square" />